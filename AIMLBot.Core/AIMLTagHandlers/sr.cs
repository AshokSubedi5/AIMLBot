...
namespace AIMLBot.Core.AIMLTagHandlers
{
    ...
    /// </summary>
    public class sr : AIMLBot.Core.Utils.AIMLTagHandler
    {
        /// <summary>
        /// Ctor
        /// </summary>
        ...
        public sr(AIMLBot.Core.Bot bot,
        ...
        protected override string ProcessChange()
        {
            if (this.templateNode.Name.ToLower() == "sr")
            {
                ...
                XmlNode sraiNode = AIMLBot.Core.Utils.AIMLTagHandler.getNode("<srai>"+starContent+"</srai>");
